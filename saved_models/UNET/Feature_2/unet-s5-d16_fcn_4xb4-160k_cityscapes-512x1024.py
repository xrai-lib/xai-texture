...
launcher = 'none'
load_from = 'trainedmodel/UNET/Feature2/iter_12000.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file='val.txt',
        data_prefix=dict(
            img_path='test/textures/Feature_2',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file='train.txt',
        data_prefix=dict(
            img_path='train/textures/Feature_2',
            seg_map_path='SegmentationClass'),
        data_root='../../masum/XAI NEW dataset',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
work_dir = 'trainedmodel/UNET/Feature2'
